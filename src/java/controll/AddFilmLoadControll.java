 ...
 * @author tinqu
 */
@WebServlet(name = "AddFilmLoadControll", urlPatterns = {"/addfilmload"})
public class AddFilmLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("pageTitle", "Thêm Film mới");
        ...
        request.getRequestDispatcher("admin/addFilm.jsp").forward(request, response);
    }
