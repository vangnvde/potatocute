 ...
 * @author tinqu
 */
@WebServlet(name = "AddFilmTypeLoadControll", urlPatterns = {"/addfilmtypeload"})
public class AddFilmTypeLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin/addFilmType.jsp").forward(request, response);
    }
