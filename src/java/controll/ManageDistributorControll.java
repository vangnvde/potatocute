 ...
 * @author tinqu
 */
@WebServlet(name = "ManageDistributorControll", urlPatterns = {"/managedistributor"})
public class ManageDistributorControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("listAllDistributor", dao.getAllDistributor());
            request.setAttribute("adminCSSFiles", "admin.css");
            request.getRequestDispatcher("admin/manageDistributor.jsp").forward(request, response);
        } catch (Exception ex) {
