 ...
 * @author tinqu
 */
@WebServlet(name = "UpdateDistributorLoadControll", urlPatterns = {"/updatedistributorload"})
public class UpdateDistributorLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Distributor detailDistributor = dao.getDistributorInfo(distributorID);
            ...
            request.setAttribute("pageTitle", detailDistributor.getNameDistributor() + " - Cập nhật");
            ...
            Logger.getLogger(UpdateDistributorLoadControll.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
