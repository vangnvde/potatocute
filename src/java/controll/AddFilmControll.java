 ...
 * @author tinqu
 */
@WebServlet(name = "AddFilmControll", urlPatterns = {"/addfilm"})
public class AddFilmControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.addFilm(nameFilm, descriptionFilm, poster, time, year, idType, idDistributor, idDirector);
