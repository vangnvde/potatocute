 ...
 * @author tinqu
 */
@WebServlet(name = "UpdateFilmTypeLoadControll", urlPatterns = {"/updatefilmtypeload"})
public class UpdateFilmTypeLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            FilmType detailFilmType = dao.getFilmTypeInfo(filmtypeID);
            ...
            request.setAttribute("pageTitle", detailFilmType.getTypeName() + " - Cập nhật");
            ...
            Logger.getLogger(UpdateFilmTypeLoadControll.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
