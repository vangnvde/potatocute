 ...
 * @author tinqu
 */
@WebServlet(name = "ChangePasswordLoadControll", urlPatterns = {"/changepasswordload"})
public class ChangePasswordLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {            
            request.setAttribute("pageTitle", user.getFullname()+" - Cập nhật Password");
            
            request.setAttribute("listType", dao.getAllFilmType());
            request.setAttribute("listDirector", dao.getAllDirector());   
            request.setAttribute("listDistributor", dao.getAllDistributor());
            request.setAttribute("listAllFilms", dao.getAllFilm());
