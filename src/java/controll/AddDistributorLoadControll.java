 ...
 * @author tinqu
 */
@WebServlet(name = "AddDistributorLoadControll", urlPatterns = {"/adddistributorload"})
public class AddDistributorLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("admin/addDistributor.jsp").forward(request, response);
    }
