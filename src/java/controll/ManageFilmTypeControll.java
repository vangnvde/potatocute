 ...
 * @author tinqu
 */
@WebServlet(name = "ManageFilmTypeControll", urlPatterns = {"/managefilmtype"})
public class ManageFilmTypeControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("listAllFilmType", dao.getAllFilmType());
            request.setAttribute("adminCSSFiles", "admin.css");
            request.getRequestDispatcher("admin/manageFilmType.jsp").forward(request, response);
        } catch (Exception ex) {
