 ...
 * @author tinqu
 */
@WebServlet(name = "AddDirectorLoadControll", urlPatterns = {"/adddirectorload"})
public class AddDirectorLoadControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("pageTitle", "Thêm Đạo diễn");
        request.setAttribute("adminCSSFiles", "admin.css");
        request.getRequestDispatcher("admin/addDirector.jsp").forward(request, response);
    }
