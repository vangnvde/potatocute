...
<jsp:include page="Header.jsp"></jsp:include>
    <!-- Header End -->
        ...
        <c:if test="${listFull == 0}">
            <!-- Hero Section End -->
            <section class="hero">
                <div class="container">
                    <div class="hero__slider owl-carousel">
                    <c:forEach items="${listFilmPopular}" var="o" begin = "13" end = "20">
                        <div class="hero__items set-bg" data-setbg="${o.getPoster()}">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="hero__text"  >
                                        <div class="label">${o.getType()}</div>
                                        <h2 style="color: gold">${o.getNameFilm()}</h2>
                                        <p style="color: gold">${o.getYear()}</p>
                                        <a href="LoadFilmDetail?idF=${o.getId()}"><span  style="background: greenyellow;">INFORMATION</span> <i style="background: greenyellow;" class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">                   
                            ...
                            <div class="row">
                                <c:if test="${listFull == 1}">
                                    ...
                                    <ul class="pc-page-list">
                                    <c:forEach begin="1" end="${pageNumber}" var="i">
                                        <li <c:if test="${ page == i }">class="pc-current-page"</c:if>><a href="home?viewAll=1&page=${i}">${i}</a></li>
                                    </c:forEach>
                                    </ul>
                                </c:if> 
